...
const Card = ({ title,totalNumber,to }: { title: string, totalNumber:number,to:string }) => {
  const count = useMotionValue(totalNumber - 10); // start 10 before total
...
//     <div className="max-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
//       <div className="flex gap-2 justify-center items-center text-center">
//         <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-black" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
//           <path strokeLinecap="round" strokeLinejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0-3-3m3 3 3-3M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
//         </svg>
//         <h5 className="mb-2 text-2xl font-semibold tracking-tight text-black">
//           {title}
...
//         <motion.span>{rounded}</motion.span>
//       </p>
//       <Link href={to} className="inline-flex font-medium items-center text-right text-blue-600 hover:underline">
//         إذهب إلى الصفحة
